function getTemplate(state){
    return `
    <div class="slider__before" style="width: ${state.width < 462 ? state.width : 231}px; background-image: url(${state.before})">
...
class Slider{
    ...
    moveHandler(event){
        this.newClientX = this.currentClientX - event.clientX;
        this.currentClientX = event.clientX;
        this.#update({width: this.state.width - this.newClientX});
        console.log(this.newClientX);
    }
}
